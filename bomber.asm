...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Declare a MACRO to check if I should display the missile 0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    MAC DRAW_MISSILE
        lda #%00000000
...
.GameLineLoop:
    DRAW_MISSILE             ; macro to check if I should draw the missile

.AreIInsideJetSprite:
    txa                      ; transfer X to A
    sec                      ; make sure carry flag is set before subtraction
    sbc JetYPos              ; subtract sprite Y-coordinate
    cmp #JET_HEIGHT          ; are I inside the sprite height bounds?
...
.DrawSpriteP0:
    ...
    tay                      ; load Y so I can work with the pointer
...
.AreIInsideBomberSprite:
    txa                      ; transfer X to A
    sec                      ; make sure carry flag is set before subtraction
    sbc BomberYPos           ; subtract sprite Y-coordinate
    cmp #BOMBER_HEIGHT       ; are I inside the sprite height bounds?
...
;; Normally, the TIA audio frequency goes from 0 (highest) to 31 (loIst).
;; subtract 31 - (JetYPos/8) to achieve the desired final pitch value.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;
;; For the low nibble I need to multiply by 5
;;   - I can use left shifts to perform multiplication by 2
;;   - for any number N, the value of N*5 = (N*2*2)+N
;;
;; For the upper nibble, since its already times 16, I need to divide it
;; and then multiply by 5:
;;   - I can use right shifts to perform division by 2
